    ...
    def create_stack(self, stack_id):
        ...
        for block_id in range(self.nb_blocks_per_stack):
            ...
            if self.share_weights_in_stack and block_id != 0:
                ...
                block = block_init(self.hidden_layer_units, self.thetas_dims[stack_id],
...
class Block(nn.Module):
    ...
    def __init__(self, units, thetas_dim, device, backcast_length=20, forecast_length=5, share_thetas=False):
        ...
        self.forcast_fc=nn.Linear(units,forecast_length)
...
class SeasonalityBlock(Block):
    ...
    def __init__(self, units, thetas_dim, device,backcast_length=20, forecast_length=10):
        super(SeasonalityBlock, self).__init__(units, thetas_dim, device, backcast_length,forecast_length, share_thetas=False)
    def forward(self, x,real_t,imag_t):
        ...
        #print("seasonBlock_type:",backcast.type)
        return backcast, forecast
...
class TrendBlock(Block):
    ...
    def forward(self, x,real_t,imag_t):
        ...
        #print("TrendBlock_type:",backcast.type)
        return backcast, forecast
...
class GenericBlock(Block):
    ...
    def forward(self, x,real_t,imag_t):
        ...
        #print("GenericBlock_type:",backcast.type)
        return backcast, forecast

...
from model_org import  NbeatsNet
...
def main():
    ...
    x_train=pd.read_csv("/home/lfn/Nbeatsd2h/data/train/trainmonthdel.csv")
    x_test=pd.read_csv("/home/lfn/Nbeatsd2h/data/train/testmonthdel.csv")
    x_afd=pd.read_csv("/home/lfn/Nbeatsd2h/data/train/trainmonthafd.csv")
    ...
    net = NbeatsNet(device=device,
                    stack_types=[NbeatsNet.GENERIC_BLOCK,NbeatsNet.GENERIC_BLOCK,NbeatsNet.GENERIC_BLOCK, NbeatsNet.GENERIC_BLOCK,NbeatsNet.SEASONALITY_BLOCK],
    ...
    best_smape=1000
    scheduler=torch.optim.lr_scheduler.StepLR(optimizer,step_size=50,gamma=0.66)

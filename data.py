...
class getM4dataset(Dataset):
    def __init__(self,backcast_length,forecast_length,dataframe_train,dataframe_test,thetas_dim,is_train=True,transform=None):
    ...
    def __getitem__(self,idx):
        ...
        if self.is_train:
            ...
            real_t=np.real(thetas)

            imag_t=np.imag(thetas)
            ...
            temp=[time_series_cleaned_forlearning_x, time_series_cleaned_forlearning_y,real_t,imag_t]
            #print("temptrain:",temp)
            return temp
        else :
            ...
            temp=[test_x,test_y,real_t,imag_t]
            #print("temp:",temp)
            return temp 
